...
{assign var="url_args" value="reqExportDoors.php"} {* AB150121 *}
{assign var="req_export_doors_url" value="$req_module$url_args"} {* AB150121 *}
...
function validateForm(f)
{
  ...
  if (f.exportType.value=="xml") { //AB141218
	  alert_message("Not Done","XML export not implemented yet. Select CSV or JSON");
  }
  return true;
}
</script>
...
<form method="post" enctype="multipart/form-data" action="{$req_export_doors_url}"
      onSubmit="javascript:return validateForm(this);"> {* AB141218 *}
    <table>
    <tr>
    <td>
    ...
    *} 
  	...
  	<td>
	  Only CSV and JSON are implemented! XML - not yet
  	</td>
  	</tr>
  	<tr>
  	<tr>
  	...
  	<select name="testPlan">
  		{html_options options=$gui->tplans}
  	</select>	  
  	</td>
  	</tr>
  	</table>
